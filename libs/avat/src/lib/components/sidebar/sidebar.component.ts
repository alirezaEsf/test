...
import { AvatSidebarService } from './sidebar.service';
...
@Component({
    selector     : 'avt-sidebar',
    templateUrl  : './sidebar.component.html',
    styleUrls    : ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class AvatSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
     ...
     * @param {AvatConfigService} _fuseConfigService
     * @param {AvatMatchMediaService} _fuseMatchMediaService
     * @param {AvatSidebarService} _fuseSidebarService

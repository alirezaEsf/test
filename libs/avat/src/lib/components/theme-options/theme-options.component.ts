...
import { AvatNavigationService } from './../navigation/navigation.service';
import { AvatSidebarService } from './../sidebar/sidebar.service';

@Component({
    selector     : 'avt-theme-options',
    templateUrl  : './theme-options.component.html',
    styleUrls    : ['./theme-options.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : avatAnimations
})
export class AvatThemeOptionsComponent implements OnInit, OnDestroy
{
    fuseConfig: any;
    form: FormGroup;
    ...
    ngOnInit(): void
    {
        ...
        this.form.valueChanges
            ...
            .subscribe((config) => {
                ...
                // Update the config
                this._avatConfigService.config = config;
            });

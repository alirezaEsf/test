...
export class AvatWidgetComponent implements AfterContentInit
{
    @HostBinding('class.flipped')
    flipped = false;

    @ContentChildren(AvatWidgetToggleDirective, {descendants: true})
    toggleButtons: QueryList<AvatWidgetToggleDirective>;
